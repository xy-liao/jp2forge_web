...
Examples:
    ...
    python test_kit/conversion_test.py

    # Test with lossy compression
    python test_kit/conversion_test.py --mode lossy

    # Test with BnF compliance for heritage documents
    python test_kit/conversion_test.py --mode bnf_compliant --document-type heritage_document
"""
...
def run_test_conversion(mode="lossless", document_type="photograph"):
    ...
    # Create output directory within test_kit
    test_kit_dir = os.path.dirname(os.path.abspath(__file__))
    output_dir = os.path.join(test_kit_dir, "test_output")
