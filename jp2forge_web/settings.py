...
VERSION = '0.1.4'  # Updated to match version in README.md
...
# Ensure we're using ManifestStaticFilesStorage for production and Docker
if not DEBUG or os.environ.get('DOCKER_ENVIRONMENT') == 'true':
